...
export default function Header() {
    ...
    return (
        <div style={{backgroundColor: variablesCSS.secondaryColor, color: 'white', padding: '.5rem', borderBottom: 'medium solid ' + variablesCSS.mainColor}}>
            <button onClick={logOut} style={{backgroundColor: variablesCSS.mainColor, padding: '.3rem', borderRadius: '.3rem', fontSize: '.8rem'}}><img src="./../../../admin/door-01.png" alt="" style={{display: 'inline', marginRight: '.3rem'}}/>Cerrar sesión</button>
        </div>
    )
}